...
export const CIVILIZATIONS: Civilization[] = [
  ...
  },
  {
    ...
    image: '/timeline/Hariri.webp',
    dates: '750–1258 AD',
    start: 750,
    end: 1258,
    color: '#4A8C6A',
    region: 'Middle East · North Africa · Spain',
    description: 'While Europe was in the Dark Ages, Islamic civilization peaked. Geometric complexity elevated to the sacred, calligraphy as holy art, architecture of breathtaking mathematical beauty.',
    longDescription: "While Western Europe passed through what historians call the Dark Ages, Islamic civilization reached heights of scientific, philosophical, and artistic achievement unmatched anywhere in the world. The Quran's ambiguous prohibition of figural imagery drove artists toward an alternative visual tradition of extraordinary sophistication: geometric pattern, calligraphy, and arabesque. Islamic geometric art is not merely decorative — its interlocking stars, hexagons, and polygons express the mathematical order underlying creation, the infinite pattern of which the visible world is a finite fragment. The Alhambra in Granada, built in the 13th and 14th centuries, demonstrates what this tradition could achieve: plaster carved into impossible lacework, light filtered through pierced screens, water channels threading through marble courts. Calligraphy was the highest art form in the Islamic world — the Arabic script, the direct vehicle of divine speech, made every letter a sacred act. The Islamic world also preserved, translated, and transmitted Greek philosophy, mathematics, and medicine — without which the European Renaissance would have had nothing to be reborn from.",
    works: ['Alhambra Palace, 14th c.', 'Dome of the Rock, 691 AD', 'Great Mosque of Córdoba, 784 AD'],
    keyWorks: [
      { title: 'Dome of the Rock', date: '691 AD' },
      { title: 'Alhambra Palace', date: '13th–14th century' },
      { title: 'Great Mosque of Córdoba', date: '784 AD' },
    ],
    artMovementTags: ['Geometric Abstraction', 'Islamic Calligraphy', 'Arabesque', 'Islamic Architecture'],
    insight: 'The pattern has no center and no edge. That is the point.',
    duration: '~500 years of peak achievement',
    quality: 'Pattern as the infinite — geometry as an expression of the divine',
    legacy: 'Preserved Greek knowledge for the Renaissance; created architectural traditions that shaped the world',
    movements: [],
  },
  {
    id: 'medieval',
