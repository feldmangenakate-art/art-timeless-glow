...
export default function Index() {
  ...
  return (
    <main style={{ minHeight: "100vh" }}>
      ...
      <div style={{ backgroundColor: "#F5F0E8", padding: "28px 40px 20px", display: "flex", flexDirection: "column", alignItems: "center", minHeight: "35vh", boxSizing: "border-box" }}>
      ...
      <div style={{ backgroundColor: "#F5F0E8" }}>
        <section style={{ padding: "4rem 2rem 5rem" }}>
          <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontStyle: "italic", fontWeight: 400, fontSize: "1.9rem", color: "rgba(42,30,16,0.45)", textAlign: "center", marginBottom: "2.75rem" }}>
